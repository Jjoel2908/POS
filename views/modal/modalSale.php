...
<div class="col-md-12">
   <div class="row justify-content-center">
      ...
      <div class="col-sm-12 col-lg-4 text-center mb-3 d-none" id="container-customer">
      ...
      <div class="col-sm-12 text-center mb-3">
         <div class="row align-items-center">
            ...
            <div id="container-image" class="col-sm-5">
            ...
            <div class="col-sm-7">
               <div class="row">
                  ...
                  <div class="col-md-6 view-form">
                     <div class="form-floating">
                        <input id="id_color" class="form-control" type="text" name="id_color" readonly>
                        <label for="id_color"><i class="fa-solid fa-barcode me-1"></i>Color</label>
                     </div>
                  </div>

                  <div class="col-md-6 view-form">
                     <div class="form-floating">
                        <input id="id_talla" class="form-control" type="text" name="id_talla" readonly>
                        <label for="id_talla"><i class="fa-solid fa-barcode me-1"></i>Talla</label>
                     </div>
                  </div>
      ...
      <div class="col-md-12 mt-3">
         <div class="table-responsive">
            <table class="table table-striped table-bordered view-table">
               ...
               <tfoot>
                  <tr>
                     <td class="text-end py-2" colspan="4"><strong>Total</strong></td>
                     <td class="text-end py-2" id="total-details">0.00</td>
                  </tr>
               </tfoot>
            </table>
         </div>
