<!-- # [ A D D   U S E R ] # -->
<div class="modal fade" id="modalAddCustomer" tabindex="-1" role="dialog" aria-labelledby="modalAddCustomerLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form class="validation" id="formAddCustomer" method="POST" action="" name="" novalidate="">
               ...
               <div class="row px-2 gap-3">
                  ...
                  <div class="col-md-12">
                     ...
                     <input class="form-control" type="hidden" name="id" id="id">
                        <input class="form-control" type="text" name="nombre" id="nombre" minlength="10" maxlength="50" placeholder="Ingrese el nombre" oninput="validateString(event)" required>
