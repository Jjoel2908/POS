...
<div class="col-md-12 view-form my-3">
    <div class="position-relative input-icon">
        ...
        <input class="form-control" type="text" name="nombre" id="nombre" maxlength="100" placeholder="Ingrese el alias para la caja" oninput="validateAndConvertToUppercase(event)" required>
