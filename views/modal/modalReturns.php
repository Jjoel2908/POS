...
<div class="col-md-12 view-form">
    <label class="mb-1" for="id_venta"><i class="fa-solid fa-basket-shopping me-1"></i> Venta</label>
    <select name="id_venta" id="id_venta" class="form-control select"></select>
</div>

<div class="col-md-12 view-form">
    <label class="mb-1" for="id_detail"><i class="fa-brands fa-slack me-1"></i> Producto</label>
...
<div class="col-md-12 view-form">
    ...
    <div class="position-relative input-icon">
        ...
        <input class="form-control" type="number" name="cantidad" id="cantidad" min="1" placeholder="Ingrese la cantidad de producto devuelto" required>
