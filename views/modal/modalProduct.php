...
<div id="container-code" class="col-md-12 view-form">
    ...
    <div class="position-relative input-icon">
        <input class="form-control" type="text" name="codigo" id="codigo" placeholder="Código del producto"
            oninput="validateString(event)" required>
...
<div class="col-md-12 view-form">
    ...
    <div class="position-relative input-icon">
        <input class="form-control" type="number" step="1" min="0" name="stock_minimo" id="stock_minimo"
            placeholder="Cantidad Mínima de producto" oninput="validateInt(event)" required>
...
<div class="col-md-6 view-form">
    ...
    <div class="position-relative input-icon">
        <input class="form-control" type="number" step="0.01" min="0" name="precio_compra" id="precio_compra"
...
<div class="col-md-6 view-form">
    ...
    <div class="position-relative input-icon">
        <input class="form-control" type="number" step="0.01" min="0" name="precio_venta" id="precio_venta"
