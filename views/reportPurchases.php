...
if ( empty($_SESSION['user']) || !in_array(11, $_SESSION['permisos']) ) header('Location: index.php');
else {
   /** ### [ H E A D E R ] ### */
...
?>
   ...
   <div id="container-report" class="card bg-transparent shadow-0 p-2">
      <div class="card-body">
         ...
         <!-- # [ S E A R C H ] # -->
         <form class="validation" id="formReportPurchase" method="POST" action="" name="" novalidate="">
         ...
         <div id="response" class="card radius-10 bg-transparent shadow-0 mt-4 d-none">
            <div class="card-header py-3 border-3">
               <div class="d-flex align-items-center justify-content-center">
                  <div>
                     <h6 class="mb-0 font-18">Resumen de Compras <span class="mx-2">|</span> <span id="day"></span></h6>
                  </div>
               </div>
            </div>
            <div class="card-body">
                     ...
                     <div class="card radius-10 view-bg mb-2">
                        <div class="card-body">
                           <div class="d-flex align-items-center">
                              <div class="me-auto">
                                 <p class="mb-0 text-white font-16">Total Compras</p>
               ...
               <div class="row mb-2">
                  <div class="col-sm-12 col-md-12">
                     <div class="table-responsive">
                        <table id="table-report-purchase" class="table table-striped view-table"></table>
                     </div>
                  </div>
               </div>
            </div>
